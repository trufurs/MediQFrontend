  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-6 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 bg-white/5 border border-white/10 rounded-2xl overflow-hidden shadow-2xl h-[450px] lg:h-[650px] relative z-10">
          <MapContainer
            center={location}
            zoom={15}
          ...
          >
            ...
            {state.places.map((place, index) => {
              const isUser = place.details?.isUser;
              const markerIcon = isUser ? userLocationIcon : storeLocationIcon;
              return (
                <Marker
                  key={index}
